# Amazon Linux with Docker installed on AWS
...
```
git clone https://github.com/mohamed-hashicorp/journey-to-flavours
```

- Change the directory to amazon-linux-podman
```
cd journey-to-flavours/amazon-linux-docker
```
